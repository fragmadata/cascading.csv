...
public class CsvConf {
  ...
  public static final String DEFAULT_CSV_RECORD_SEPARATOR = "\n";
  public static final String DEFAULT_CSV_QUOTE_CHARACTER = "\"";
  public static final String DEFAULT_CSV_QUOTE_MODE = QuoteMode.MINIMAL.name();
  public static final String DEFAULT_CSV_ESCAPE_CHARACTER = "\\";
  public static final String DEFAULT_CSV_NULL_STRING = "NULL";
  ...
  static CSVFormat createFormat(Configuration conf) {
    return CSVFormat.newFormat(conf.get(CsvConf.CSV_DELIMITER, CsvConf.DEFAULT_CSV_DELIMITER).charAt(0))
      .withHeader(conf.getStrings(CsvConf.CSV_COLUMNS))
